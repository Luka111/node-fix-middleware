...
Listeners.prototype.onCreateListener = function(emitter,sessionID){
  console.log(emitter + ' EVENT onCreate: got Session ID - ' + JSON.stringify(sessionID));
};

Listeners.prototype.onLogonListener = function(emitter,sessionID){
  console.log(emitter + ' EVENT onLogon: got Session ID - ' + JSON.stringify(sessionID));
};

Listeners.prototype.onLogoutListener = function(emitter,sessionID){
  console.log(emitter + ' EVENT onLogout: got Session ID - ' + JSON.stringify(sessionID));
};

Listeners.prototype.onLogonAttemptListener = function(emitter,message,sessionID){
  console.log(emitter + ' EVENT onLogonAttempt: got message - ' + JSON.stringify(message) + ' .Session ID - ' + JSON.stringify(sessionID));
};

Listeners.prototype.toAdminListener = function(emitter,message,sessionID){
  console.log(emitter + ' EVENT toAdmin: got message - ' + JSON.stringify(message) + ' .Session ID - ' + JSON.stringify(sessionID));
};

Listeners.prototype.fromAdminListener = function(emitter,message,sessionID){
  console.log(emitter + ' EVENT fromAdmin: got message - ' + JSON.stringify(message) + ' .Session ID - ' + JSON.stringify(sessionID));
};

Listeners.prototype.fromAppListener = function(emitter,msg, sessionID){
  console.log(emitter + ' EVENT fromApp: got app message - ' + JSON.stringify(msg) + ' .Session ID - ' + JSON.stringify(sessionID));
};
